# AI Workplace Productivity Portfolio — Student / Academic Research Assistant

## Trainee Information
- Trainee Name: Awadh Mohammed Alhajri
- Training Program: L0-FGP — Generative AI for Workplace Productivity
- Instructor: Fahad Alqahtani
- Date: 1 September 2026

## Project Overview
This portfolio demonstrates how a Student / Academic Research Assistant can use generative AI to improve routine academic workplace tasks while keeping human judgment and responsibility at the center. The repository shows structured prompting, professional writing, information processing, planning, verification, responsible AI use, and a practical integration plan. All examples are fictional or anonymized and are designed around one consistent academic research support scenario.

## Selected Workplace Scenario
The selected workplace scenario is a **Student / Academic Research Assistant supporting a university research team**. The role includes coordinating meetings, drafting professional emails, turning research-team notes into action items, planning small academic events and research tasks, verifying AI-generated content, and using AI responsibly without exposing confidential or personal information.
...
| Section | Description |
|---|---|
| Prompt Engineering | Reusable academic workplace prompts using C.A.R.E. and R.C.T.O. |
| Writing Workflow | A professional meeting-rescheduling email shown through all review stages |
| Information Workflow | Transformation of messy research-team notes into a decision-ready action table |
| Planning Workflow | AI-assisted planning for a student research seminar |
...
| Integration Plan | Practical plan for future AI use in the academic research assistant role |
